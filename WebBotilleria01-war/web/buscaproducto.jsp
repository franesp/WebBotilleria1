...
<html>
    ...
    <body style="background-color:powderblue;">
        ...
        <form name="frm_buscar" method="get" action="ObtenerDatosProductoServlet">
            ...
            <input type="text" name="ingresa_producto" placeholder="Ingresa producto" alt="pro"required>
            <label style=" text-align: center;">Código:</label>
            <input type="Integer" name="ingresa_codigo" placeholder="Ingrese codigo" alt="1"required>
